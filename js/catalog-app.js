...
(function () {
  ...
  // Registro con el mes gratis — el mismo link que usa toda la web
  const REGISTRO_URL = 'https://app.vortexvip.org/register?code=hMXSHQE8P4';
        ...
        <div class="player-center">
          ...
          <div class="player-paywall" data-paywall>
            ...
            <div class="player-actions">
              <a class="btn-register" href="${REGISTRO_URL}" target="_blank" rel="noopener">Registrate y obtené 1 mes gratis</a>
            </div>
          </div>
        </div>
